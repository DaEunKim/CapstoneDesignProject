...
def imageDownlad(imageUrl, count):
    ...
    file_path = "Images/001/image_"+str(count)+".jpg"
    ...
    new_im.save("Images/001/image_"+str(count)+".jpg")
...
with db.cursor() as curs:
    ...
    sql = "SELECT product_file_name,product_shopping_img_url FROM product WHERE product_file_name > 2499 AND product_file_name < 3001"
    curs.execute(sql)
